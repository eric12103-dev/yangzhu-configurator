  ...
  reader.onload = e => {
    ...
    fabric.Image.fromURL(e.target.result, img => {
      ...
      if (_isLeatherRound) {
        ...
        // 御守皮革：圖片填滿並裁切到御守形狀（SVG viewBox 162.1×261.6，印刷區路徑）
        const _sx = w / 162.1;
        const _sy = h / 261.6;
